...
#                CableHeight = 2*(Const.Height-Const.JointHeight)/3
                ...
                cable1.addObject('CableConstraint', template='Vec3d', name='CableConstraint', indices=list(range(2*NSegments)), pullPoint=[0, CableHeight, 0], printLog=True, value=10.5)                               
